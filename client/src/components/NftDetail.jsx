    ...
    if (window.ethereum) {
      ...
      try {
        ...
        const tokenContract = new web3.eth.Contract(
          Token.abi,
          "0x9f2b776240227B73A513d9c60dD6c0B508Ca9BFF"
        );
        // Mint the token
        const mintTx = await tokenContract.methods
          .safeMint(
            "0x5d79EDd26fFaa50279205778eCE9ed4E36459008",
            "https://ipfs.io/ipfs/QmXTox97TMCKe5HRZnmGGARsmt4FqVBZRMsdTUsnaB5BHv?filename=ticket_1.png"
          )
            ...
            <div className="flex-1 pr-8">
              <div className="relative">
                <div className="shadow-lg rounded-lg overflow-hidden transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110">
                  <img
                    src="../funding_detail/NFTs_ticket.jpg"
                    alt="NFT"
            ...
            <div className="flex-1 relative">
              <div className="bg-white rounded-lg shadow-lg p-6 absolute right-0 top-0 ">
                ...
                <p className="text-sm text-gray-600 mb-4">
                  Total Items: 1000 | Created on: 01/01/2023 | Chain: Ethereum |
                  Location: Bangkok Thailand
                </p>
                <p className="text-sm text-gray-600 mb-4">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin
                  vitae nulla non dolor sollicitudin ullamcorper in eu eros. In
                  hac habitasse platea dictumst. Fusce id odio augue.
                </p>
                ...
                <div className="flex justify-between items-center">
                  <button
                    className="bg-green-600 text-white py-2 px-4 rounded-lg hover:bg-green-700 animate-bounce"
